...
const form = (props: IFormProps) => {
    ...
    const prodOptions = props.prods.map(e => <Select key={e.key} value={e.value}>{e.value}</Select>);
    const repoOptions = props.repos.map(e => <Select key={e.key} value={e.value}>{e.value}</Select>);
    const orderOptions = props.orders.map(e => <Select key={e.key} value={e.value}>{e.value}</Select>);
    return (
        <Form
